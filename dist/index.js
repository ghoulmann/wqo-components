...
var WqoConceptView = () => {
  const Component = ({ fileData }) => {
    ...
    if (!fm) return null;
    if (!toArray(fm.tags).includes("lexicon")) return null;
    const slug = fileData.slug ?? "";
    const root = pathToRoot(slug);
    const wn = fm.wordnet;
    const wordnetSection = wn ? /* @__PURE__ */ jsxs("div", { class: "wqo-section", children: [
      /* @__PURE__ */ jsx("div", { class: "wqo-section-title", children: "Definitions" }),
      toArray(wn.definitions).map((d, i) => /* @__PURE__ */ jsxs("div", { class: "wqo-wordnet-def", children: [
        '"',
        d,
        '"'
      ] }, i)),
      wn.synonyms && wn.synonyms.length > 0 && /* @__PURE__ */ jsxs("div", { class: "wqo-wordnet-meta", children: [
        /* @__PURE__ */ jsx("strong", { children: "Also known as:" }),
        " ",
        toArray(wn.synonyms).join(", ")
      ] }),
      wn.related_forms && wn.related_forms.length > 0 && /* @__PURE__ */ jsxs("div", { class: "wqo-wordnet-meta", children: [
        /* @__PURE__ */ jsx("strong", { children: "Related forms:" }),
        " ",
        toArray(wn.related_forms).join(", ")
      ] })
    ] }) : null;
    const cl = fm.classification;
    const dimSection = cl ? /* @__PURE__ */ jsxs("div", { class: "wqo-section", children: [
      /* @__PURE__ */ jsx("div", { class: "wqo-section-title", children: "Classification" }),
      Object.entries(DIMENSION_LABELS).map(([key, label]) => {
        const val = cl[key];
        if (!val) return null;
        const chips = toArray(val);
        return /* @__PURE__ */ jsxs("div", { class: "wqo-dim-group", children: [
          /* @__PURE__ */ jsx("span", { class: "wqo-dim-label", children: label }),
          chips.map((c, i) => /* @__PURE__ */ jsx("span", { class: "wqo-chip", children: labelify(c) }, i))
        ] }, key);
      })
    ] }) : null;
    const rels = fm.relationships;
    const relsSection = rels && Object.keys(rels).length > 0 ? /* @__PURE__ */ jsxs("div", { class: "wqo-section", children: [
      /* @__PURE__ */ jsx("div", { class: "wqo-section-title", children: "Relationships" }),
      Object.entries(rels).map(([relType, targets]) => {
        const links = toArray(targets);
        return /* @__PURE__ */ jsxs("div", { class: "wqo-rel-section", children: [
          /* @__PURE__ */ jsx("div", { class: "wqo-rel-type", children: REL_LABELS[relType] ?? labelify(relType) }),
          /* @__PURE__ */ jsx("div", { class: "wqo-rel-links", children: links.map((t, i) => /* @__PURE__ */ jsx("a", { href: `${root}/lexicon/${t}`, children: labelify(t) }, i)) })
        ] }, relType);
      })
    ] }) : null;
    const conceptId = slug.split("/").pop() ?? slug;
    const graphData = rels && Object.keys(rels).length > 0 ? JSON.stringify({ id: conceptId, name: fm.title ?? conceptId, rels }) : null;
    const graphSection = graphData ? /* @__PURE__ */ jsxs("div", { class: "wqo-section", children: [
      /* @__PURE__ */ jsx("div", { class: "wqo-section-title", children: "Concept Graph" }),
      /* @__PURE__ */ jsx("div", { class: "wqo-graph", "data-relationships": graphData })
    ] }) : null;
    return /* @__PURE__ */ jsxs("div", { class: "wqo-concept", children: [
      wordnetSection,
      dimSection,
      relsSection,
      graphSection
...
var src_default = WqoConceptView;
export {
  WqoConceptView,
